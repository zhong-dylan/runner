...
public class D3GameAttribute : MonoBehaviour {
    ...
    [HideInInspector]
    public string SceneTitleToload = "Main";
    [HideInInspector]
    ...
    private void NormalizeTitleScene()
    {
        if (SceneTitleToload == "TitleInfintyRunner" || SceneTitleToload == "TitleInfinityRunner" || SceneTitleToload == "TitleScene")
        {
            SceneTitleToload = "Main";
        }
    }
